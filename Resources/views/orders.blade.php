...
<html lang="en">
    ...
    <body class="gs bs hi g_ sidebar-expanded" :class="{ 'sidebar-expanded': sidebarExpanded }"
        ...
        <div class="flex ss la">
            ...
            <div>
                ...
                <div class="m w bg-slate-900 pu tb tex ted bz wr opacity-0 pointer-events-none"
                    :class="sidebarOpen ? 'ba' : 'opacity-0 pointer-events-none'" aria-hidden="true"></div>

                <!-- Sidebar -->
                <div id="sidebar"
                    class="flex ak g tb x k tea tec teh tts ss lp tth l or tej ttz 2xl:!w-64 ub hs dw we wr wu -translate-x-64"
                    ...
                    <div class="flex fe nx vq j_">
                        <!-- Close button -->
                        <button class="tex text-slate-500 xl" @click.stop="sidebarOpen = !sidebarOpen"
                    ...
                    <div class="ff">
                        ...
                        <div>
                            ...
                            <ul class="nk">
                                ...
                                <li class="vn vr rounded-sm n_ ww" x-data="{ open: false }">
                                    <a class="block gj hover--text-slate-200 ld wt wi" href="#0"
                                        ...
                                        <div class="flex items-center fe">
                                            <div class="flex items-center">
                                                ...
                                                <span
                                                    class="text-sm gp ml-3 ttw tnn 2xl:opacity--100 wr">Dashboard</span>
                                            </div>
                                            <!-- Icon -->
                                            <div class="flex ub nq ttw tnn 2xl:opacity--100 wr">
                                                <svg class="w-3 h-3 ub nz du gq ao" :class="open ? 'as' : 'ao'"
                                                    viewBox="0 0 12 12">
                                        ...
                                        <ul class="me re hidden" :class="open ? '!block' : 'hidden'">
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    href="analytics.html">
                                                    <span
                                                        class="text-sm gp ttw tnn 2xl:opacity--100 wr">Analytics</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                ...
                                <li class="vn vr rounded-sm n_ ww bg-slate-900" x-data="{ open: true }">
                                    <a class="block gj ld wt wi" href="#0"
                                        ...
                                        <div class="flex items-center fe">
                                            <div class="flex items-center">
                                                ...
                                                <span
                                                    class="text-sm gp ml-3 ttw tnn 2xl:opacity--100 wr">E-Commerce</span>
                                            </div>
                                            <!-- Icon -->
                                            <div class="flex ub nq ttw tnn 2xl:opacity--100 wr">
                                                <svg class="w-3 h-3 ub nz du gq as" :class="open ? 'as' : 'ao'"
                                                    viewBox="0 0 12 12">
                                                    <path d="M5.9 11.4L.5 6l1.4-1.4 4 4 4-4L11.3 6z"></path>
                                                </svg>
                                            </div>
                                    ...
                                    <div class="tex ttj 2xl:block">
                                        <ul class="me re hidden !block" :class="open ? '!block' : 'hidden'">
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    href="customers.html">
                                                    <span
                                                        class="text-sm gp ttw tnn 2xl:opacity--100 wr">Customers</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                                <a class="block text-indigo-500 wt wi ld" href="orders.html">
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld" href="product.html">
                                                    <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Single
                                                        Product</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                    ...
                                    <a class="block gj xc ld wt wi" href="#0"
                                        ...
                                        <div class="flex items-center fe">
                                            <div class="flex items-center">
                                                ...
                                                <span
                                                    class="text-sm gp ml-3 ttw tnn 2xl:opacity--100 wr">Community</span>
                                            </div>
                                            <!-- Icon -->
                                            <div class="flex ub nq ttw tnn 2xl:opacity--100 wr">
                                                <svg class="w-3 h-3 ub nz du gq ao" :class="open ? 'as' : 'ao'"
                                        ...
                                        <ul class="me re hidden" :class="open ? '!block' : 'hidden'">
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    ...
                                                    <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Users -
                                                        Tabs</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    ...
                                                    <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Forum -
                                                        Post</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    ...
                                                    <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Meetups -
                                                        Post</span>
                                                </a>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="me re hidden" :class="open ? '!block' : 'hidden'">
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    ...
                                                    <span
                                                        class="text-sm gp ttw tnn 2xl:opacity--100 wr">Transactions</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    href="transaction-details.html">
                                                    <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Transaction
                                                        Details</span>
                                                </a>
                                            </li>
                                        </ul>
                                    ...
                                    <a class="block gj xc ld wt wi" href="#0"
                                        ...
                                        <div class="flex items-center fe">
                                            <div class="flex items-center">
                                                ...
                                                <span class="text-sm gp ml-3 ttw tnn 2xl:opacity--100 wr">Job
                                                    Board</span>
                                            </div>
                                            <!-- Icon -->
                                            <div class="flex ub nq ttw tnn 2xl:opacity--100 wr">
                                        ...
                                        <ul class="me re hidden" :class="open ? '!block' : 'hidden'">
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    ...
                                                    <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Company
                                                        Profile</span>
                                                </a>
                                            </li>
                                        </ul>
                                    ...
                                    <a class="block gj xc ld wt wi" href="messages.html">
                                        <div class="flex items-center fe">
                                            <div class="uw flex items-center">
                                                ...
                                                <span
                                                    class="text-sm gp ml-3 ttw tnn 2xl:opacity--100 wr">Messages</span>
                                            </div>
                                            <!-- Badge -->
                                            <div class="flex uy nq">
                                                <span
                                                    class="inline-flex items-center justify-center su go gp ye ho vi rounded">4</span>
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                    ...
                                    <a class="block gj xc ld wt wi" href="#0"
                                        ...
                                        <div class="flex items-center fe">
                                            <div class="flex items-center">
                                                ...
                                                <span
                                                    class="text-sm gp ml-3 ttw tnn 2xl:opacity--100 wr">Settings</span>
                                            </div>
                                            <!-- Icon -->
                                            <div class="flex ub nq ttw tnn 2xl:opacity--100 wr">
                                                <svg class="w-3 h-3 ub nz du gq ao" :class="open ? 'as' : 'ao'"
                                        ...
                                        <ul class="me re hidden" :class="open ? '!block' : 'hidden'">
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld" href="settings.html">
                                                    <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">My
                                                        Account</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    ...
                                                    <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Connected
                                                        Apps</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld" href="billing.html">
                                                    <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Billing &amp;
                                                        Invoices</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld" href="feedback.html">
                                                    <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Give
                                                        Feedback</span>
                                                </a>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="me re hidden" :class="open ? '!block' : 'hidden'">
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    href="changelog.html">
                                                    <span
                                                        class="text-sm gp ttw tnn 2xl:opacity--100 wr">Changelog</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    ...
                                                    <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Empty
                                                        State</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    ...
                                                    <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Knowledge
                                                        Base</span>
                                                </a>
                                            </li>
                                        </ul>
                        ...
                        <div>
                            ...
                            <ul class="nk">
                                <!-- Authentication -->
                                <li class="vn vr rounded-sm n_ ww" x-data="{ open: false }">
                                    <a class="block gj xc wt wi" :class="open &amp;&amp; 'hover--text-slate-200'"
                                        href="#0"
                                        @click.prevent="sidebarExpanded ? open = !open : sidebarExpanded = true">
                                        <div class="flex items-center fe">
                                            <div class="flex items-center">
                                                ...
                                                <span
                                                    class="text-sm gp ml-3 ttw tnn 2xl:opacity--100 wr">Authentication</span>
                                            </div>
                                            <!-- Icon -->
                                            <div class="flex ub nq ttw tnn 2xl:opacity--100 wr">
                                                <svg class="w-3 h-3 ub nz du gq ao" :class="open ? 'as' : 'ao'"
                                        ...
                                        <ul class="me re hidden" :class="open ? '!block' : 'hidden'">
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    ...
                                                    <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Reset
                                                        Password</span>
                                                </a>
                                            </li>
                                        </ul>
                                    ...
                                    <a class="block gj xc wt wi" :class="open &amp;&amp; 'hover--text-slate-200'"
                                        ...
                                        <div class="flex items-center fe">
                                            <div class="flex items-center">
                                                ...
                                                <span
                                                    class="text-sm gp ml-3 ttw tnn 2xl:opacity--100 wr">Onboarding</span>
                                            </div>
                                            <!-- Icon -->
                                            <div class="flex ub nq ttw tnn 2xl:opacity--100 wr">
                                                <svg class="w-3 h-3 ub nz du gq ao" :class="open ? 'as' : 'ao'"
                                    ...
                                    <a class="block gj xc wt wi" :class="open &amp;&amp; 'hover--text-slate-200'"
                                        ...
                                        <div class="flex items-center fe">
                                            <div class="flex items-center">
                                                ...
                                                <span
                                                    class="text-sm gp ml-3 ttw tnn 2xl:opacity--100 wr">Components</span>
                                            </div>
                                            <!-- Icon -->
                                            <div class="flex ub nq ttw tnn 2xl:opacity--100 wr">
                                                <svg class="w-3 h-3 ub nz du gq ao" :class="open ? 'as' : 'ao'"
                                        ...
                                        <ul class="me re hidden" :class="open ? '!block' : 'hidden'">
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    ...
                                                    <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Input
                                                        Form</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    ...
                                                    <span class="text-sm gp ttw tnn 2xl:opacity--100 wr">Alert &amp;
                                                        Banner</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    ...
                                                    <span
                                                        class="text-sm gp ttw tnn 2xl:opacity--100 wr">Pagination</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    ...
                                                    <span
                                                        class="text-sm gp ttw tnn 2xl:opacity--100 wr">Breadcrumb</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                            ...
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
                                                    ...
                                                    <span
                                                        class="text-sm gp ttw tnn 2xl:opacity--100 wr">Accordion</span>
                                                </a>
                                            </li>
                                            <li class="rt ww">
                                                <a class="block gq hover--text-slate-200 wt wi ld"
            ...
            <div class="y flex ak ug ll lc">
                        ...
                        <div class="flex items-center fe sa rr">
                            ...
                            <div class="flex">
                                ...
                                <button class="text-slate-500 hover--text-slate-600 tex"
                                    ...
                                    :aria-expanded="sidebarOpen" aria-expanded="false">
                            ...
                            <div class="flex items-center fl">
                                ...
                                <div x-data="{ searchOpen: false }">
                                    ...
                                    <!-- Modal backdrop -->
                                    <div class="m w bg-slate-900 pu tx bz" x-show="searchOpen"
                                        x-transition:enter="wt wa wr" x-transition:enter-start="opacity-0"
                                        x-transition:enter-end="ba" x-transition:leave="wt wa ws"
                                        x-transition:leave-start="ba" x-transition:leave-end="opacity-0"
                                        aria-hidden="true" style="display: none;"></div>
                                    <!-- Modal dialog -->
                                    <div id="search-modal" class="m w tx la flex aj _ ri justify-center vs jj"
                                        role="dialog" aria-modal="true" x-show="searchOpen"
                                        x-transition:enter="wt wu wr" x-transition:enter-start="opacity-0 u_"
                                        x-transition:enter-end="ba uj" x-transition:leave="wt wu wr"
                                        ...
                                        <div class="bg-white lu ua ou oe rounded bd" @click.outside="searchOpen = false"
                                            ...
                                            <form class="cs border-slate-200">
                                                <div class="y">
                                                    ...
                                                    <input id="modal-search" class="ou cn kf bo av vo mn mr"
                                                    ...
                                                    <ul class="text-sm">
                                                        <li>
                                                            <a class="flex items-center dx text-slate-800 xc xn rounded kk"
                                                                ...
                                                                <svg class="oo sl du gq kq _t ub ra"
                                                                    viewBox="0 0 16 16">
                                                                    <path
                                                    ...
                                                    <ul class="text-sm">
                                                        <li>
                                                            <a class="flex items-center dx text-slate-800 xc xn rounded kk"
                                                                ...
                                                                <span><span class="gp text-slate-800 kq">Messages</span>
                                    ...
                                    <div class="uk tk g z q rf _g ut bg-white border border-slate-200 va rounded bd la re"
                                        ...
                                        <ul>
                                            <li class="cs border-slate-200 wk">
                                                <a class="block vr vs xr" href="#0" @click="open = false"
                                                    @focus="open = true" @focusout="open = false">
                                                    <span class="block text-sm ru">📣 <span
                                                            class="gp text-slate-800">Edit your information in a
                                                            swipe</span> Sint occaecat cupidatat non proident, sunt in
                                            ...
                                            <li class="cs border-slate-200 wk">
                                                <a class="block vr vs xr" href="#0" @click="open = false"
                                                    @focus="open = true" @focusout="open = false">
                                                    <span class="block text-sm ru">🚀<span class="gp text-slate-800">Say
                                ...
                                <div class="y inline-flex" x-data="{ open: false }">
                                    <button class="inline-flex justify-center items-center kk" aria-haspopup="true"
                                        ...
                                        <img class="os sf rounded-full" src="./images/user-avatar-32.png" width="32"
                                            height="32" alt="User">
                ...
                <main>
                    <div class="vs jj ttm vl ou uf na">
                        ...
                        <section class="text-sm" x-data="{ open: false }">
                            <article class="flex bg-white items-center justify-between">
                                <div class="grow flex">

                                    <div class="px-2 wy w_ vo lm">
                                    ...
                                    <div class="px-2 wy w_ vo lm">
                                        <div class="inline-flex gp hb ya rounded-full gn vp vd">Refunded
                                        </div>
                                    </div>
                                    <div class="px-2 wy w_ vo lm">
                                        <div class="gn">1</div>
                                ...
                                {{-- collapse toggle --}}
                                <div class="w-16 px-2 wy w_ vo lm of">
                                    <div class="flex items-center">
                            ...
                            <article id="description-01" role="region" x-show="open" style="">
                                <div colspan="10" class="vi wy w_ vo">
                                    <div class="flex items-center hp dk rz">
                                        <svg class="oo sl ub du bg-slate-400 mr-2">
                                            <path
                                        ...
                                        <div class="gm">Excepteur sint occaecat cupidatat non proident,
                        ...
                        <div class="je jd jc rc">
                            ...
                            <div class="sn am jo az jp ft">
                                ...
                                <div class="table-items-action hidden">
                                    <div class="flex items-center">
                                        <div class="hidden tnh text-sm gm mr-2 lm"><span
                                ...
                                <div class="y" x-data="{ open: false, selected: 2 }">
                                    ...
                                    <div class="tk g z q ou bg-white border border-slate-200 va rounded bd la re"
                                        @click.outside="open = false" @keydown.escape.window="open = false"
                                        x-show="open" x-transition:enter="wt wa ws au"
                                        x-transition:enter-start="opacity-0 uq" x-transition:enter-end="ba uj"
                                        ...
                                        <div class="gp text-sm g_" x-ref="options">
                                            ...
                                            <button tabindex="0"
                                                class="flex items-center ou xr vf vn al text-indigo-500"
                                    ...
                                    <table class="ux ou le lr">
                                        ...
                                        <tbody class="text-sm" x-data="{ open: false }">
                                            ...
                                            <tr>
                                                ...
                                                <td class="vi wy w_ vo lm">
                                                    <div class="flex items-center text-slate-800">
                                                        <div
                                                            class="od sy ub flex items-center justify-center hi rounded-full mr-2 _b">
                                                            <img class="nz" src="./images/icon-01.svg" width="20"
                                                ...
                                                <td class="vi wy w_ vo lm of">
                                                    <div class="flex items-center">
                                                        <button class="gq xv au as" :class="{ 'as': open }"
                                                            @click.prevent="open = !open" :aria-expanded="open"
                                                            aria-controls="description-01" aria-expanded="true">
                                                            <span class="d">Menu</span>
                                                            <svg class="os sf du" viewBox="0 0 32 32">
                                            ...
                                            -->
                                            <tr id="description-01" role="region" x-show="open" style="">
                                        ...
                                        <tbody class="text-sm" x-data="{ open: false }">
                                            ...
                                            <tr>
                                                ...
                                                <td class="vi wy w_ vo lm">
                                                    <div class="inline-flex gp hc ys rounded-full gn vp vd">Approved
                                                    </div>
                                                </td>
                                                <td class="vi wy w_ vo lm">
                                                    <div class="gn">2</div>
                                                ...
                                                <td class="vi wy w_ vo lm of">
                                                    <div class="flex items-center">
                                                        <button class="gq xv au as" :class="{ 'as': open }"
                                                            @click.prevent="open = !open" :aria-expanded="open"
                                                            aria-controls="description-02" aria-expanded="true">
                                                            <span class="d">Menu</span>
                                                            <svg class="os sf du" viewBox="0 0 32 32">
                                                                <path d="M16 20l-5.4-5.4 1.4-1.4 4 4 4-4 1.4 1.4z">
                                                                </path>
                                            ...
                                            and it should match the number of columns in your table
                                            -->
                                            <tr id="description-02" role="region" x-show="open" style="">
                                                <td colspan="10" class="vi wy w_ vo">
                                                    <div class="flex items-center hp dk rz">
                                                        <svg class="oo sl ub du gq mr-2">
                                                            <path
                                            ...
                                            <tr>
                                                ...
                                                <td class="vi wy w_ vo lm">
                                                    <div class="flex items-center text-slate-800">
                                                        <div
                                                            class="od sy ub flex items-center justify-center hi rounded-full mr-2 _b">
                                                            <img class="nz" src="./images/icon-02.svg" width="20"
                                                                height="20" alt="Icon 02">
                                                        </div>
                                                        <div class="gp yv">#143567</div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="vi wy w_ vo lm of">
                                                    <div class="flex items-center">
                                                        <button class="gq xv au" :class="{ 'as': open }"
                                                            @click.prevent="open = !open" :aria-expanded="open"
                                                            aria-controls="description-03" aria-expanded="false">
                                                            <span class="d">Menu</span>
                                                            <svg class="os sf du" viewBox="0 0 32 32">
                                                                <path d="M16 20l-5.4-5.4 1.4-1.4 4 4 4-4 1.4 1.4z">
                                                                </path>
                                        ...
                                        <tbody class="text-sm" x-data="{ open: false }">
                                            ...
                                            <tr>
                                                ...
                                                <td class="vi wy w_ vo lm">
                                                    <div class="inline-flex gp hi text-slate-500 rounded-full gn vp vd">
                                                        Pending</div>
                                                </td>
                                                <td class="vi wy w_ vo lm">
                                                    <div class="gn">1</div>
                                                ...
                                                <td class="vi wy w_ vo lm of">
                                                    <div class="flex items-center">
                                                        <button class="gq xv au" :class="{ 'as': open }"
                                                            @click.prevent="open = !open" :aria-expanded="open"
                                                            aria-controls="description-04" aria-expanded="false">
                                                            <span class="d">Menu</span>
                                                            <svg class="os sf du" viewBox="0 0 32 32">
                                                                <path d="M16 20l-5.4-5.4 1.4-1.4 4 4 4-4 1.4 1.4z">
                                                                </path>
                                            ...
                                            <tr>
                                                ...
                                                <td class="vi wy w_ vo lm">
                                                    <div class="flex items-center text-slate-800">
                                                        <div
                                                            class="od sy ub flex items-center justify-center hi rounded-full mr-2 _b">
                                                            <img class="nz" src="./images/icon-03.svg" width="20"
                                                                height="20" alt="Icon 03">
                                                        </div>
                                                ...
                                                <td class="vi wy w_ vo lm of">
                                                    <div class="flex items-center">
                                                        <button class="gq xv au" :class="{ 'as': open }"
                                                            @click.prevent="open = !open" :aria-expanded="open"
                                                            aria-controls="description-05" aria-expanded="false">
                                                            <span class="d">Menu</span>
                                                            <svg class="os sf du" viewBox="0 0 32 32">
                                                                <path d="M16 20l-5.4-5.4 1.4-1.4 4 4 4-4 1.4 1.4z">
                                                                </path>
                                            ...
                                            <tr>
                                                ...
                                                <td class="vi wy w_ vo lm of">
                                                    <div class="flex items-center">
                                                        <button class="gq xv au" :class="{ 'as': open }"
                                                            @click.prevent="open = !open" :aria-expanded="open"
                                                            aria-controls="description-06" aria-expanded="false">
                                                            <span class="d">Menu</span>
                                                            <svg class="os sf du" viewBox="0 0 32 32">
                                                                <path d="M16 20l-5.4-5.4 1.4-1.4 4 4 4-4 1.4 1.4z">
                                                                </path>
                                            ...
                                            <tr>
                                                ...
                                                <td class="vi wy w_ vo lm of">
                                                    <div class="flex items-center">
                                                        <button class="gq xv au" :class="{ 'as': open }"
                                                            @click.prevent="open = !open" :aria-expanded="open"
                                                            aria-controls="description-07" aria-expanded="false">
                                                            <span class="d">Menu</span>
                                                            <svg class="os sf du" viewBox="0 0 32 32">
                                                                <path d="M16 20l-5.4-5.4 1.4-1.4 4 4 4-4 1.4 1.4z">
                                                                </path>
                                            ...
                                            <tr>
                                                ...
                                                <td class="vi wy w_ vo lm of">
                                                    <div class="flex items-center">
                                                        <button class="gq xv au" :class="{ 'as': open }"
                                                            @click.prevent="open = !open" :aria-expanded="open"
                                                            aria-controls="description-08" aria-expanded="false">
                                                            <span class="d">Menu</span>
                                                            <svg class="os sf du" viewBox="0 0 32 32">
                                                                <path d="M16 20l-5.4-5.4 1.4-1.4 4 4 4-4 1.4 1.4z">
                                                                </path>
                                            ...
                                            <tr>
                                                ...
                                                <td class="vi wy w_ vo lm of">
                                                    <div class="flex items-center">
                                                        <button class="gq xv au" :class="{ 'as': open }"
                                                            @click.prevent="open = !open" :aria-expanded="open"
                                                            aria-controls="description-09" aria-expanded="false">
                                                            <span class="d">Menu</span>
                                                            <svg class="os sf du" viewBox="0 0 32 32">
                                                                <path d="M16 20l-5.4-5.4 1.4-1.4 4 4 4-4 1.4 1.4z">
                                                                </path>
                                            ...
                                            <tr>
                                                ...
                                                <td class="vi wy w_ vo lm of">
                                                    <div class="flex items-center">
                                                        <button class="gq xv au" :class="{ 'as': open }"
                                                            @click.prevent="open = !open" :aria-expanded="open"
                                                            aria-controls="description-10" aria-expanded="false">
                                                            <span class="d">Menu</span>
                                                            <svg class="os sf du" viewBox="0 0 32 32">
                                                                <path d="M16 20l-5.4-5.4 1.4-1.4 4 4 4-4 1.4 1.4z">
                                                                </path>
        ...
        <script>
            const pagesList = [{
                ...
                "name": "Knowledge Base",
                "url": "https://preview.cruip.com/mosaic/knowledge-base.html",
                "active": false
            }, {
                "name": "Sign in",
                "url": "https://preview.cruip.com/mosaic/signin.html",
                "active": false
            }, {
                "name": "Sign up",
                "url": "https://preview.cruip.com/mosaic/signup.html",
                "active": false
            }, {
                "name": "Reset password",
                "url": "https://preview.cruip.com/mosaic/reset-password.html",
                "active": false
            }, {
                "name": "Onboarding 1",
                "url": "https://preview.cruip.com/mosaic/onboarding-01.html",
                "active": false
            }, {
                "name": "Onboarding 2",
                "url": "https://preview.cruip.com/mosaic/onboarding-02.html",
                "active": false
            }, {
                "name": "Onboarding 3",
                "url": "https://preview.cruip.com/mosaic/onboarding-03.html",
                "active": false
            }, {
                "name": "Onboarding 4",
                "url": "https://preview.cruip.com/mosaic/onboarding-04.html",
                "active": false
            }, {
                "name": "Button",
                "url": "https://preview.cruip.com/mosaic/component-button.html",
                "active": false
            }, {
                "name": "Input Form",
                "url": "https://preview.cruip.com/mosaic/component-form.html",
                "active": false
            }, {
                "name": "Dropdown",
                "url": "https://preview.cruip.com/mosaic/component-dropdown.html",
                "active": false
            }, {
                "name": "Alert & Banner",
                "url": "https://preview.cruip.com/mosaic/component-alert.html",
                "active": false
            }, {
                "name": "Modal",
                "url": "https://preview.cruip.com/mosaic/component-modal.html",
                "active": false
            }, {
                "name": "Pagination",
                "url": "https://preview.cruip.com/mosaic/component-pagination.html",
                "active": false
            }, {
                "name": "Tabs",
                "url": "https://preview.cruip.com/mosaic/component-tabs.html",
                "active": false
            }, {
                "name": "Breadcrumb",
                "url": "https://preview.cruip.com/mosaic/component-breadcrumb.html",
                "active": false
            }, {
                "name": "Badge",
                "url": "https://preview.cruip.com/mosaic/component-badge.html",
                "active": false
            }, {
                "name": "Avatar",
                "url": "https://preview.cruip.com/mosaic/component-avatar.html",
                "active": false
            }, {
                "name": "Tooltip",
                "url": "https://preview.cruip.com/mosaic/component-tooltip.html",
                "active": false
            }, {
                "name": "Accordion",
                "url": "https://preview.cruip.com/mosaic/component-accordion.html",
                "active": false
            }, {
                "name": "Icons",
                "url": "https://preview.cruip.com/mosaic/component-icons.html",
                "active": false
            }];
            if (window != top) {
